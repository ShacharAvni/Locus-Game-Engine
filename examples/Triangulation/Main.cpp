...
static const char* Window_Name = "Locus Triangulation Example";
...
#endif
{
   try
   {
      ...
      Locus::Window window(windowContext, monitorWidth / 2, monitorHeight / 2, Window_Name, false, &targetRefreshRate);
