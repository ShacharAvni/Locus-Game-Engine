...
static bool ParseSAPFile(rapidxml::xml_document<>& xmlDocument, MeshVector_t& meshes);

bool ParseSAPFile(const std::string& fullFilePath, MeshVector_t& meshes)
{
...
bool ParseSAPFile(const MountedFilePath& mountedFilePath, MeshVector_t& meshes)
{
...
bool ParseSAPFile(DataStream& sapDataStream, MeshVector_t& meshes)
{
